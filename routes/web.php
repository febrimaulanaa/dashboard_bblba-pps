...
Route::get('/admin301097', function() { 
    return '<html><head><title>Admin</title><style>body{font-family:Arial;padding:20px}ul{list-style:none;padding:0}li{display:inline-block;margin:5px 10px;padding:10px;background:#006191;border-radius:5px}li a{color:white;text-decoration:none}</style></head><body><h1>Dashboard Admin</h1><ul><li><a href="/admin301097/pkbjj">PKBJJ</a></li><li><a href="/admin301097/osmb">OSMB</a></li><li><a href="/admin301097/seminar">Seminar</a></li><li><a href="/admin301097/wtku">WTKU</a></li><li><a href="/admin301097/wisuda">Wisuda</a></li><li><a href="/admin301097/tuweb">Tuweb</a></li><li><a href="/admin301097/users">Users</a></li></ul></body></html>'; 
});
Route::get('/admin301097/pkbjj', function() { return '<html><head><title>PKBJJ</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Data PKBJJ</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/osmb', function() { return '<html><head><title>OSMB</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Data OSMB</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/seminar', function() { return '<html><head><title>Seminar</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Data Seminar</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/wtku', function() { return '<html><head><title>WTKU</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Data WTKU</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/wisuda', function() { return '<html><head><title>Wisuda</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Data Wisuda</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/tuweb', function() { return '<html><head><title>Tuweb</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Jadwal Tuweb</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
Route::get('/admin301097/users', function() { return '<html><head><title>Users</title><style>body{font-family:Arial;padding:20px}.btn{background:#006191;color:white;padding:10px;text-decoration:none;border-radius:5px}</style></head><body><h1>Manajemen Users</h1><a href="/admin301097" class="btn">&laquo; Kembali</a><p>CRUD: Import/Export via routes</p></body></html>'; });
