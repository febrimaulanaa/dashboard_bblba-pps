...
<div class="card mb-4">
    ...
    <div class="card-header">
        ...
        <p class="text-muted mb-0">{{ $event->description ?? 'Silakan isi formulir di bawah ini dengan data yang benar untuk keperluan pencetakan sertifikat.' }}</p>
    </div>
</div>
...
<form action="{{ route('sertifikat.submit', $event->slug) }}" method="POST">
    ...
    <div class="card mb-4">
        <div class="card-body p-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Budi Santoso, S.Kom., M.Kom.">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" value="{{ old('nim') }}" required placeholder="Masukkan NIM/NIK Anda">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Sertifikat akan dikirimkan otomatis ke email ini. Pastikan email aktif dan penulisan benar.</div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="study_program" name="study_program" value="{{ old('study_program') }}">
                </div>
                <div class="col-md-6 mb-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <button type="submit" class="btn btn-primary px-4 py-2" style="background-color: #006191; border-color: #006191;">Kirim & Dapatkan Sertifikat</button>
    </div>
</form>
@endsection
