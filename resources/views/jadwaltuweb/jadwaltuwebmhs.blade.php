                                    ...
                                    <td class="px-8 py-6 min-w-[200px]">
                                        <div class="flex flex-col gap-1">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <a href="${item.lokasi && item.lokasi.startsWith('http') ? item.lokasi : 'https://www.google.com/maps/search/?api=1&query=' + encodeURIComponent(item.lokasi || '')}" target="_blank" class="text-sm font-medium text-primary hover:underline transition-colors">
                                                    ${item.lokasi || '-'}
                                                </a>
                                            </div>
                                            ${item.link_tuweb ? `
