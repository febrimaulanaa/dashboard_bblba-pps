            ...
            <div class="container mt-sm-5 mt-3">
                <div class="row pt-lg-6">
                    <div class="col-lg-3">
                        <div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
                            <h3>Menu Lain</h3>
                            <h6 class="text-secondary font-weight-normal pe-3">Lorem Ipsum</h6>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="row mt-3">
                            <div class="col-md-4 mt-md-0 mt-4">
                                <a href="./sections/navigation/nav-tabs.html">
                                    ...
                                    <div class="mt-2 ms-2">
                                        <h6 class="mb-0">Jadwal TUWEB 2021.2</h6>
                            ...
                            <div class="col-md-4 mt-md-0 mt-4">
                                <a href="{{ route('daftartutor') }}">
                                    <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                        <img class="w-100 m-auto" src="{{ asset('assets/img/tutor.png') }}" alt="">
                                    </div>
                                    <div class="mt-2 ms-2">
                                        <h6 class="mb-0">Daftar Tutor UT Jakarta</h6>
                                        <p class="text-secondary text-sm">Daftar nama tutor ut jakarta</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-4 mt-md-0 mt-4">
                                <a href="./sections/navigation/pagination.html">
                                    <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                        <img class="w-100 m-auto" src="{{ asset('assets/img/materi.png') }}" alt="">
                                    </div>
                                    <div class="mt-2 ms-2">
                                        <h6 class="mb-0">Materi OSMB dan PKBJJ</h6>
                                        <p class="text-secondary text-sm">Materi OSMB dan PKBJJ</p>
                                    </div>
                                </a>
                            </div>
                        </div>
