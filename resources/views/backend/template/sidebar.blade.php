        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="base">
                        <ul class="nav nav-collapse">
                            <li
                                class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'osmb' ? 'active' : '' }}">
                                <a href="{{ route('adminosmb') }}">
                                    <span class="sub-item">OSMB</span>
                                </a>
                            </li>
                            <li
                                class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'pkbjj' ? 'active' : '' }}">
                                <a href="{{ route('adminpkbjj') }}">
                                    <span class="sub-item">PKBJJ</span>
                                </a>
                            </li>
                            <li
                                class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'wtku' ? 'active' : '' }}">
                                <a href="{{ route('adminwtku') }}">
                                    <span class="sub-item">Workshop Tugas & KU</span>
                                </a>
                            </li>
                            <li
                                class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'seminar' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-collapse">
                        <li
                            class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'jadwalpkbjj' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-collapse">
                        <li
                            class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'wisuda' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-collapse">
                        <li
                            class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'tuweb' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sertifikat-sistem">
                        <ul class="nav nav-collapse">
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'sistem-sertifikat' && !Request::segment(3) ? 'active' : '' }}">
                                <a href="{{ route('admin.sertifikat.dashboard') }}">
                                    <span class="sub-item">Dashboard</span>
                                </a>
                            </li>
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'sistem-sertifikat' && Request::segment(3) == 'events' ? 'active' : '' }}">
                                <a href="{{ route('admin.sertifikat.events') }}">
                                    <span class="sub-item">Kegiatan</span>
                                </a>
                            </li>
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'sistem-sertifikat' && Request::segment(3) == 'templates' ? 'active' : '' }}">
                                <a href="{{ route('admin.sertifikat.templates') }}">
                                    <span class="sub-item">Template Sertifikat</span>
                                </a>
                            </li>
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'sistem-sertifikat' && Request::segment(3) == 'participants' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="pegawai">
                        <ul class="nav nav-collapse">
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'users' ? 'active' : '' }}">
                                <a href="{{ route('admin.users') }}">
                                    <span class="sub-item">Manajemen Pegawai</span>
                                </a>
                            </li>
                            <li class=" {{ Request::segment(1) == 'app' && Request::segment(2) == 'absensi' ? 'active' : '' }}">
