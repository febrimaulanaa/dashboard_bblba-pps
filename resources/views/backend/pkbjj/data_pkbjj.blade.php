...
@section('title', 'Data PKBJJ')

@section('content')
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h4 class="card-title mb-0">Data Peserta PKBJJ</h4>
    </div>
    <div class="card-body">
                                <div class="d-grid gap-2 d-md-block">
                                    <a class="btn btn-success my-3" data-toggle="modal" data-target="#ajaxModel">ADD
                                        DATA</a>
                                    <a href="{{ route('export') }}" class="btn btn-info my-3">EXPORT EXCEL</a>
