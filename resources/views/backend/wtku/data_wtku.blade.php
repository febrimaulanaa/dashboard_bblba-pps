...
@section('title', 'Data WTKU')

@section('content')
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h4 class="card-title mb-0">Data Peserta WTKU</h4>
    </div>
    <div class="card-body">
                                <div class="d-grid gap-2 d-md-block">
                                    <a class="btn btn-success my-3" data-toggle="modal" data-target="#ajaxModel">ADD
                                        DATA</a>
                                    <a href="{{ route('exportwtku') }}" class="btn btn-info my-3">EXPORT EXCEL</a>
                                    ...
                                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form method="post" action="{{ route('importwtku') }}"
            ...
            $('#savedata').on('click', function() {
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        $('#taskError').text(response.responseJSON.errors.wtku);
                    }
                });
            })
        });
