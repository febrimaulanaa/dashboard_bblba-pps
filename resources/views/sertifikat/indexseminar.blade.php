...
@section('title', 'Sertifikat Seminar - Dashboard Pembelajaran UT Jakarta')
...
@section('content')
  <main class="mt-24 pb-20 min-h-[calc(100vh-200px)] flex flex-col justify-center items-center px-6">
    <div class="w-full max-w-2xl text-center mb-12">
      <h1 class="text-3xl md:text-4xl font-extrabold font-headline tracking-tight text-purple-700 mb-2">Form Sertifikat Seminar Akademik</h1>
      <h2 class="text-xl md:text-2xl font-bold text-sky-700">Universitas Terbuka Jakarta</h2>
      <p class="text-on-surface-variant mt-4 text-sm md:text-base">Masukkan Nomor Induk Mahasiswa Anda untuk mencetak sertifikat Seminar Akademik.</p>
    </div>
    ...
    <div class="bg-surface-container-lowest p-8 md:p-12 rounded-2xl shadow-xl border border-outline-variant/10 w-full max-w-xl relative overflow-hidden">
      ...
      <div class="absolute -top-24 -right-24 w-48 h-48 bg-purple-100 rounded-full blur-3xl"></div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="nim" name="nim" placeholder="Masukkan NIM Anda" required
                        class="block w-full pl-12 pr-4 py-4 bg-surface rounded-xl border-outline-variant/50 focus:border-purple-600 focus:ring focus:ring-purple-600/20 transition-all font-body text-on-surface placeholder-outline-variant shadow-inner">
                </div>
            </div>
